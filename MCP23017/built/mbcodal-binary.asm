...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 2668 (incl. 1864 user, 746 helpers, 14 vtables, 44 lits); src size 0
; assembly: 1865 lines; density: 74.56 bytes/stmt; (25 stmts)
; total bytes: 285292 (217.7% of 128.0k flash with -154220 free)
; peep hole pass: 36 instructions removed and 41 updated
...
; start
    ...
    .hex DFAC8DCD5B17864A ; hex template hash
...
; endfun
    ;
; Function WritePin MCP23017.ts:125
    ;
    .section code
    .balign 4
    .section code
MCP23017_WritePin__P810:
MCP23017_WritePin__P810_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
MCP23017_WritePin__P810_locals:
    ldr r7, [r6, #0]
    ldr r0, [r7, #12]
    mov r7, sp
    str r7, [r6, #4]
    ...
    beq .else_0_3      
.jmpz2:
    bl MCP23017_initMCP23017__P808
_proccall3:
    @stackempty locals
.else_0_3:
.afterif_1_3:
...
.ret.810:
    ...
    movs r0, #0
.final_4_3:
MCP23017_WritePin__P810_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function i2cwrite MCP23017.ts:70
    ;
    .section code
    .balign 4
    .section code
MCP23017_i2cwrite__P806:
MCP23017_i2cwrite__P806_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    ...
    push {r0} ;loc
    @stackmark locals
MCP23017_i2cwrite__P806_locals:
    movs r0, #2
    mov r7, sp
    str r7, [r6, #4]
...
.final_0_4:
    add sp, #4*1 ; pop locals 1
MCP23017_i2cwrite__P806_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function initMCP23017 MCP23017.ts:83
    ;
    .section code
    .balign 4
    .section code
MCP23017_initMCP23017__P808:
MCP23017_initMCP23017__P808_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    ...
    push {r0} ;loc
    @stackmark locals
MCP23017_initMCP23017__P808_locals:
    movs r0, #1
    str r0, [sp, locals@0]
    @stackempty locals
.fortop.852:
...
.final_4_5:
    add sp, #4*1 ; pop locals 1
MCP23017_initMCP23017__P808_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
